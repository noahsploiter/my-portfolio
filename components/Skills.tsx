...
function Skills({ skills }: Props) {
  return (
    ...
    >
      <h3 className="absolute top-[90px] uppercase tracking-[15px] text-gray-500 text-2xl xl:top-[30px]">
        Skills
      </h3>

      <h3 className="absolute  top-[160px] xl:top-[80px] uppercase tracking-[2px] text-gray-500 text-sm">
